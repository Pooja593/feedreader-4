...
$(function() {
  ...
  describe("Initial Entries", function() {
    ...
    it("initial entries must be greater than zero", function() {
  ...
  describe("New Feed Selection", function() {
    ...
    beforeEach(function(done) {
      loadFeed(0, function() {
        firstEntries = $('.entry').html();
        loadFeed(1, function() {
          secondEntries = $('.entry').html();
          done();
        });
      });
    });
    it("initial entries is varied from final entries", function() {
